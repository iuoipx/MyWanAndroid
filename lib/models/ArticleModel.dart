class ArticleModel {
  ...
  ArticleModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new ArticleItemModel.fromJson(json['data']) : null;
...
class ArticleItemModel {
  ...
  ArticleItemModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<ArticleItemModels>();
      json['datas'].forEach((v) {
        datas.add(new ArticleItemModels.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class ArticleItemModels {
  ...
  ArticleItemModels.fromJson(Map<String, dynamic> json) {
