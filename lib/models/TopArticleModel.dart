class TopArticleModel {
  ...
  TopArticleModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<TopArticleItemModel>();
      json['data'].forEach((v) {
        data.add(new TopArticleItemModel.fromJson(v));
      });
    }
...
class TopArticleItemModel {
  ...
  TopArticleItemModel.fromJson(Map<String, dynamic> json) {
